...
/*                 for (int k = 0; k < vetor.length; k++) {
    ...
    public static class ArvoreBinariaBusca {
      ...
      // Implementar um método para encontrar o pai
      //
      //implementarem o sucesser e o antecessor
      // site: https://visualgo.net/pt/bst
